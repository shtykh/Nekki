...
3) Run *init.sh*(*init.bat* in windows) to create user *shtykhnekki_user*, database *shtykhnekki* and table *entry* in it for application needs (I really hope you didn't name objects in your database same as me, otherwise <a href ="http://rs1img.memecdn.com/if-you-forget-to-put-text-on-your-meme-your-gonna-have-a-bad-time_o_834474.jpg">you're gonna have bad time</a>).<br>
